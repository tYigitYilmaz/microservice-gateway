...
import com.qwerty.microservices.netflixzuulgateway.zuulFilter.zuulLoginFilter;
...
@WebMvcTest(zuulLoginFilter.class)
   ...
   /* @BeforeEach
    ...
    public void currencyExchange() throws Exception{
        ...
        RequestBuilder request = MockMvcRequestBuilders
                .post("/account-service/currency-feign/currency-exchange/from/{from}/to/{to}",from,to)
                .param("accountNumber", String.valueOf(ACCOUNT_NUMBER))
                .param("conversionAmount", String.valueOf(CONVERSION_AMOUNT))
